       ...
       <img class="img-responsive" src="images/apartelle.png" style="width:100%; height:180px;">      
        ...
        <div class="row" style="color: #ed9e21">
            <div class="col-md-12 well" >
              ...
              <p>Online D&Y apartelle reservations are a popular method for booking rooms. Travelers can book rooms on a computer by using online security to protect their privacy and financial information and by using several online travel agents to compare prices and facilities at different hotels</p>
              <br>
              ...
              <br>
              <p>Online D&Y apartelle reservations are also helpful for making last minute travel arrangements. apartelle may drop the price of a room if some rooms are still available. There are several websites that specialize in searches for deals on rooms.</p>
        ...
        <div class="row" style="color: #ffbb2b">
            <div class="col-md-4 wellfix">
              ...
              Address : Bangas A, Hinunangan, Southern Leyte<br>
              Mail : Unknown@gmail.com <br>
            </div>
            <div class="col-md-4"></div>
            <div class="col-md-4 wellfix">
                <h4><strong>Developed By</strong></h4><hr>
                <a href="#">Kim Cabodbod</a>
