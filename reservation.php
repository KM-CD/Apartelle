                ...
                while($row = mysqli_fetch_array($result))
                {
                   ...
                   echo "
                            ...
                            <div class='col-md-5 well'>
                                ...
                                <h6> <span>No of Beds:</span> ".$row2['no_bed']." ".$row2['bedtype']." bed.</h6>
                                <h6> <span>Available Rooms:</span> ".$row2['available']."</h6>
                                <h6> <span>Facilities:</span> ".$row2['facility']."</h6>
                                <h6> <span>Price: </span>".$row2['price']." night.</h6>
                            </div>
                            <div class='col-md-3'>
